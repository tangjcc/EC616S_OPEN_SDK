...
#if defined(_WIN32)
#define mbedtls_snprintf   _snprintf
#else
...
FN_OID_GET_ATTR1(EC_mbedtls_oid_get_attr_short_name, oid_x520_attr_t, x520_attr, const char *, short_name)
...
FN_OID_GET_ATTR1(EC_mbedtls_oid_get_x509_ext_type, oid_x509_ext_t, x509_ext, int, ext_type)
...
FN_OID_GET_ATTR1(EC_mbedtls_oid_get_extended_key_usage, mbedtls_oid_descriptor_t, ext_key_usage, const char *, description)
...
FN_OID_GET_DESCRIPTOR_ATTR1(EC_mbedtls_oid_get_sig_alg_desc, oid_sig_alg_t, sig_alg, const char *, description)
FN_OID_GET_ATTR2(EC_mbedtls_oid_get_sig_alg, oid_sig_alg_t, sig_alg, mbedtls_md_type_t, md_alg, mbedtls_pk_type_t, pk_alg)
FN_OID_GET_OID_BY_ATTR2(EC_mbedtls_oid_get_oid_by_sig_alg, oid_sig_alg_t, oid_sig_alg, mbedtls_pk_type_t, pk_alg, mbedtls_md_type_t, md_alg)
#endif /* MBEDTLS_MD_C */
...
FN_OID_GET_ATTR1(EC_mbedtls_oid_get_pk_alg, oid_pk_alg_t, pk_alg, mbedtls_pk_type_t, pk_alg)
FN_OID_GET_OID_BY_ATTR1(EC_mbedtls_oid_get_oid_by_pk_alg, oid_pk_alg_t, oid_pk_alg, mbedtls_pk_type_t, pk_alg)
...
FN_OID_GET_OID_BY_ATTR1(EC_mbedtls_oid_get_oid_by_ec_grp, oid_ecp_grp_t, oid_ecp_grp, mbedtls_ecp_group_id, grp_id)
...
FN_OID_GET_ATTR1(EC_mbedtls_oid_get_cipher_alg, oid_cipher_alg_t, cipher_alg, mbedtls_cipher_type_t, cipher_alg)
...
FN_OID_GET_ATTR1(EC_mbedtls_oid_get_md_alg, oid_md_alg_t, md_alg, mbedtls_md_type_t, md_alg)
FN_OID_GET_OID_BY_ATTR1(EC_mbedtls_oid_get_oid_by_md, oid_md_alg_t, oid_md_alg, mbedtls_md_type_t, md_alg)
#endif /* MBEDTLS_MD_C */
...
FN_OID_GET_ATTR2(EC_mbedtls_oid_get_pkcs12_pbe_alg, oid_pkcs12_pbe_alg_t, pkcs12_pbe_alg, mbedtls_md_type_t, md_alg, mbedtls_cipher_type_t, cipher_alg)
...
int EC_mbedtls_oid_get_numeric_string( char *buf, size_t size,
