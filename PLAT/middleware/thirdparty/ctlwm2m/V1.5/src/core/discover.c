                                               ...
                                               lwm2m_server_t * serverP)
{
    ...
    observedP = ct_observe_findByUri(contextP, uriP);
...
int ct_discover_serialize(lwm2m_context_t * contextP,
                       lwm2m_uri_t * uriP,
                       lwm2m_server_t * serverP,
                       int size,
                       lwm2m_data_t * dataP,
                       uint8_t ** bufferP)
{
    ...
    baseUriLen = ctlwm2m_uri_toString(uriP, baseUriStr, URI_MAX_STRING_LEN, NULL);
