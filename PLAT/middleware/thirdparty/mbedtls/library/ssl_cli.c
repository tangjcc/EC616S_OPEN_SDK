                                               ...
                                               size_t *olen )
{
    ...
    *olen = 0;
    ...
    if( ssl->conf->mfl_code == MBEDTLS_SSL_MAX_FRAG_LEN_NONE ) {
        MBEDTLS_SSL_DEBUG_MSG( 3, ( "client hello, adding max_fragment_length extension fail" ) );
        return;
    }
...
int mbedtls_ssl_handshake_client_step( mbedtls_ssl_context *ssl )
{
    ...
    ECOMM_TRACE(UNILOG_SSL, mbedtls_ssl_handshake_client_step_1, P_INFO, 1, "client state: %d", ssl->state);
...
#endif
    //ECOMM_TRACE(UNILOG_SSL, mbedtls_ssl_handshake_client_step_2, P_ERROR, 1, "client state: %d", ssl->state);
