...
static int ssl_parse_client_hello( mbedtls_ssl_context *ssl )
{
    ...
    ECOMM_TRACE(UNILOG_SSL, ssl_parse_client_hello_1, P_INFO, 0, ".....=> ssl_parse_client_hello");
...
static int ssl_write_server_hello( mbedtls_ssl_context *ssl )
{
    ...
    ECOMM_TRACE(UNILOG_SSL, ssl_write_server_hello_1, P_INFO, 0, ".....=> ssl_write_server_hello");
...
static int ssl_write_server_key_exchange( mbedtls_ssl_context *ssl )
{
    ...
    ECOMM_TRACE(UNILOG_SSL, ssl_write_server_key_exchange_1, P_INFO, 0, ".....=> ssl_write_server_key_exchange");
