...
//#define MBEDTLS_PLATFORM_PRINTF_MACRO        MqttLogout /**< Default printf macro to use, can be undefined */
/* Note: your snprintf must correclty zero-terminate the buffer! */
//#define MBEDTLS_PLATFORM_SNPRINTF_MACRO    snprintf /**< Default snprintf macro to use, can be undefined */
//#define MBEDTLS_PLATFORM_NV_SEED_READ_MACRO   mbedtls_platform_std_nv_seed_read /**< Default nv_seed_read function to use, can be undefined */
//#define MBEDTLS_PLATFORM_NV_SEED_WRITE_MACRO  mbedtls_platform_std_nv_seed_write /**< Default nv_seed_write function to use, can be undefined */
//#define MBEDTLS_PLATFORM_CALLOC_MACRO(x, y) \
//1?do \
//{\
 //   printf("call calloc %s %d\n", __FILE__, __LINE__);  \
 //   pvPortCalloc(x, y);\
//}while(0):0

//extern void *pvMyPortCalloc( int nmemb, int size, char * file, char * line );

//#define MBEDTLS_PLATFORM_CALLOC_MACRO(x,y) pvMyPortCalloc(x,y,__FILE__, __LINE__)
//#define MBEDTLS_PLATFORM_CALLOC_MACRO(x,y) pvMyPortCalloc()
//#define MBEDTLS_PLATFORM_CALLOC_MACRO emq_calloc
