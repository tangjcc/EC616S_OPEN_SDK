                             ...
                             security_instance_t * targetP)
{
    ...
    case LWM2M_SECURITY_URI_ID:
        ...
        ECOMM_STRING(UNILOG_LWM2M, prv_get_value_1, P_INFO, "targetP->uri=%S", (uint8_t*)targetP->uri);
    ...
    case LWM2M_SECURITY_SECURITY_ID:
        ...
        ECOMM_TRACE(UNILOG_LWM2M, prv_get_value_0, P_INFO, 1, "targetP->securityMode=%d", targetP->securityMode);
        return COAP_205_CONTENT;
                                 ...
                                 lwm2m_object_t * objectP)
{
    ...
    uint8_t result;
    int i;
    ECOMM_TRACE(UNILOG_LWM2M, prv_security_read_0, P_INFO, 1, "enter numDataP=%d",*numDataP);
                                     ...
                                     bool isBootstrap)
{
    ...
    if (NULL != securityObj)
    {
        ...
        ECOMM_TRACE(UNILOG_LWM2M, get_security_object_0, P_INFO, 1, "targetP->securityMode=%d",targetP->securityMode);
