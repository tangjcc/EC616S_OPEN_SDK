...
#else
#define ONENET_MAIN_TASK_STACK_SIZE   1024*2
#endif
...
typedef struct {
    ...
    UINT32 onenetId;
    cis_time_t lifeTime;
    onenetObjectInfo objectInfo[2];
    uint8_t observeObjNum;
    observed_backup_t gObservedBackup[2];
    UINT8 host[ONENET_HOST_NAME_LEN];
    UINT8  otaFinishState;
    UINT32 reqhandle;
    cisMIPLCfg mMiplcfg;
    ...
    UINT8 identify[ONENET_PSKID_LEN];
    UINT8 secret[ONENET_PSK_LEN];
} onenetRetentionContext_v0;

#define CIS_NVM_FILE_VERSION_1   1
typedef struct {
    //offset 0
    UINT32 bUsed:8;
    UINT32 bConnected:8;
    UINT32 bRestoreFlag:8;
    UINT32 FotaState:8;
    //offset 0x4
    UINT32 lifeTime;
    //offset 0x8
    ...
    onenetObjectInfo objectInfo[2];
    observed_backup_t gObservedBackup[2];
} onenetRetentionContext_v1;

#define CIS_NVM_FILE_VERSION_2   2
typedef struct {
    //offset 0
    UINT32 bUsed:8;
    UINT32 bConnected:8;
...
} onenetRetentionContext_v2;

typedef onenetRetentionContext_v2 onenetRetentionContext;
