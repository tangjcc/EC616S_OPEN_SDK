 ...
 *          TP-Discharge-Time: "yy/MM/dd,hh:mm:ss±zz"
 * 9. <fo>      integer format
...
/*
 * FO:
 * SMS-SUBMIT first octet, refer to 23.040 9.2.2.2
 *   7                                   0
 * +----+----+----+----+----+----+----+----+
...
typedef enum
{
    ...
    PSIL_MSG_CODING_8BIT          = 0x01,   /* 8 bit data */
    PSIL_MSG_CODING_UCS2          = 0x02,   /* UCS2 (16bit) */
