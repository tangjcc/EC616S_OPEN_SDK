...
CmsRetId psGetDNSWithoutCache(UINT32 atHandle, UINT8* url );
...
CmsRetId psStartPingWithOutUrl(UINT32 atHandle, UINT8 *pAddr, INT16 addr_len, INT32 count, INT32 size, INT32 timeout, BOOL raiFlag);
