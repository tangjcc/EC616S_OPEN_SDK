...
#!!!!!! blank space is senstive, do not add!!!!!
BUILD_AT_REF=y
PS_AT_REF=y
#!!!!!! blank space is senstive, do not add!!!!!
ifeq ($(PS_AT_REF), y)
CFLAGS += -DPS_NB_SUPPORT_HS_REF_FEATURE
endif
...
CFLAGS += -D__EC616S -DCHIP_EC616S --no_integer_literal_pools
ASMFLAGS += --predefine "CHIP_EC616S SETL {TRUE} "
LDFLAGS += --diag_suppress=L6480
