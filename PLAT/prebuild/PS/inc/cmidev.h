...
typedef enum CMI_DEV_PRIM_ID_TAG
{
    ...
    CMI_DEV_GET_PSSLP_CFG_REQ,   //AT+ECPSSLPCFG?
    CMI_DEV_GET_PSSLP_CFG_CNF,

    CMI_DEV_SET_PSSLP_CFG_REQ,   //AT+ECPSSLPCFG = "minT3324",<T1>,"minT3324",<T2>,"minEDRXPeriod",<T3>
...
typedef struct CmiDevSetExtCfgReq_Tag
{
    ...
    BOOL    t3324AndT3412ExtCeregUrcPresent;        //Enable <Active-Time>/<Periodic-TAU> URC in AT+CEREG=5
    BOOL    t3324AndT3412ExtCeregUrc;
    UINT16  rsvd2;

#ifdef PS_NB_SUPPORT_HS_REF_FEATURE
    BOOL    cfun1PowerOnPsPresent;      //AT REF marco open: after cfun1 whether need to power on ps
    BOOL    cfun1PowerOnPs;
    UINT16  rsvd3;
#endif
    ...
    BOOL    enableHPPlmnSearchPresent;              //Enable High Priority Plmn Search
    BOOL    enableHPPlmnSearch;

    BOOL    enableNonIpNoSmsPresent;              //Enable NON IP NO SMS
    ...
    BOOL    disableSib14CheckPresent;
    BOOL    disableSib14Check;   /*While sib14 is configured by NW, ue use it check ACBaring Check or not*/
...
typedef struct CmiDevGetExtCfgCnf_Tag
{
    ...
    BOOL    enableSimPsm;           //+ECCFG:USIMPOWERSAVE, XX /+NCONFIG:NAS_SIM_POWER_SAVING_ENABLE, XX
...
typedef struct CmiDevGetExtStatusCnf_Tag
{
    ...
    UINT8                           bPowerOn;
    UINT8                           rsvd[2];
    CmiDevPhyStatusInfo             phyStatus;  //72 bytes
    CmiDevL2StatusInfo              l2Status;   //4 bytes
    CmiDevRrcStatusInfo             rrcStatus;  //56 bytes
...
}CmiDevGetExtStatusCnf; //420 bytes
...
typedef CacCmiEmptySig CmiDevErrcExitDeactInd;


/******************************************************************************
 * CMI_DEV_GET_PSSLP_CFG_REQ
 * AT+ECPSSLPCFG?
 *  +ECPSSLPCFG="minT3324", value, "minT3412", value, "minEDRXPeriod", value
******************************************************************************/
 ...
 * AT+ECPSSLPCFG="minT3324",<T1>,"minT3412",<T2>,"minEDRXPeriod",<T3>
******************************************************************************/
