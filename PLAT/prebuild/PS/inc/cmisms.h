...
typedef enum CMI_SMS_PRIM_ID_TAG
{
    ...
    CMI_SMS_SET_MORE_MESSAGE_MODE_REQ,  //AT+CMMS=
...
/* Refer to TS 24.008-10.5.4.7 Called party BCD number */
typedef enum CmiSmsNumTypeEnum_Tag
{
    ...
    CMI_SMS_NUMTYPE_DEDICATED = 4,      //Dedicated access, short code
...
typedef enum CmiSmsNumPlanEnum_Tag
{
    ...
    CMI_SMS_NUMPLAN_E164_E163 = 1,  //ISDN/telephony numbering plan (ITU-T Rec. E.164 [45] / ITU-T Rec. E.163 [44])
    ...
    CMI_SMS_NUMPLAN_RSVD_CTS = 11,  //Reserved for CTS
    CMI_SMS_NUMPLAN_EXTENSION = 15  //Reserved for Extension
...
typedef struct CmiSmsGetSupportedSmsServiceCnf_Tag
{
    CmiSmsRcCode                rc;
    UINT8                       length;
    CmiSmsService               serviceList[SMS_SERVICE_NUM];
...
{
    CMI_SMS_DISABLE_MORE_MESSAGE_SEND = 0,     //disable
...
typedef CacCmiEmptySig CmiSmsSetMoreMessageModeCnf;

typedef CacCmiEmptySig CmiSmsGetMoreMessageModeReq;
