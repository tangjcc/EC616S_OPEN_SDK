 ...
 * Description:  EC616S platform sleep management header file
...
#define PMU_DEFAULT_BL_TIME                     (10)

#define PMU_FLASH_WRITE_TIME_2SECTOR_GD            (77+4)             // page write max time 2.4ms, 2 sector 76.8ms, 4ms Vbat ADC check
#define PMU_FLASH_WRITE_TIME_2SECTOR_XMC            (96+4)            // page write max time 3ms, 2 sector 96ms, 4ms Vbat ADC check
#define PMU_FLASH_WRITE_TIME_2SECTOR_DFT            (96+4)            // page write max time 3ms, 2 sector 96ms, 4ms Vbat ADC check        

#define PMU_PREHIB_EXPECTED_CODE_RUNNING_TIME     (PMU_FLASH_WRITE_TIME_2SECTOR_DFT+2)			// time for code running before sleep
#define PMU_PRESLP2_EXPECTED_CODE_RUNNING_TIME     (PMU_FLASH_WRITE_TIME_2SECTOR_DFT+2)			// time for code running before sleep


#define PMU_WORTH_HIB_TIME                   (50+PMU_PREHIB_EXPECTED_CODE_RUNNING_TIME)
#define PMU_POSTHIB_EXPECTED_CODE_RUNNING_TIME      (51)

#define PMU_WORTH_SLP2_TIME                   (50+PMU_PRESLP2_EXPECTED_CODE_RUNNING_TIME)
#define PMU_POSTSLP2_EXPECTED_CODE_RUNNING_TIME     (51)
