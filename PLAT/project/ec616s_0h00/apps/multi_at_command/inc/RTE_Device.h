...
// { PAD_PIN17},  // 0 : gpio6 / 1 : UART0 RTSn / 3 : SPI1 SSn
// { PAD_PIN18},  // 0 : gpio7 / 1 : UART0 CTSn / 3 : SPI1 MOSI
// { PAD_PIN19},  // 0 : gpio8 / 1 : UART0 RXD  / 3 : SPI1 MISO
// { PAD_PIN20},  // 0 : gpio9 / 1 : UART0 TXD  / 3 : SPI1 SCLK
