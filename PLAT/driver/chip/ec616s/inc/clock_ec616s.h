 ...
 * File name:    clock_ec616s.h
 * Description:  EC616S clock driver header file
 * History:      Rev1.0   2019-02-20
 *
 ****************************************************************************/

#ifndef _CLOCK_EC616S_H
#define _CLOCK_EC616S_H
...
typedef enum _sw_reset_ID
{
    ...
    GPR_ResetLPUARTAONFunc   = 23U,          /**< LPUART AON Func reset    */
