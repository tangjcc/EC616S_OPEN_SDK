 ...
 *          definitions and memory mapping for EC616S chip.
 *
 * @file   ec616s.h
 * @author
 * @date   12/Nov/2018
...
/* ARMCM3 Specific Interrupt Numbers  */
  ...
  LpuartWakeup_IRQn             =   2,      /**< Lpuart Wakeup Interrupt */
...
/* Peripheral Specific Interrupt Numbers  */
  ...
  PXIC_Lpuart_IRQn              =   54,     /**< Lpuart Interrupt */
...
#include "system_ec616s.h"                        /* System Header */
...
#define LPUSARTAON_BASE_ADDR                     (APB_PERIPH_BASE + 0x0000A0) /**< LPUSART AON base address */
...
#define LPUSARTCORE_BASE_ADDR                    (APB_PERIPH_BASE + 0x180040) /**< LPUSART CORE base address */
...
typedef struct {
    ...
    __IO uint32_t ECFG;                          /**< ADC extral configuration Register,            offset: 0x40 */
} ADC_TypeDef;
...
/** @name ECFG - ADC_ECFG register */
/** @{ */
#define ADC_ECFG_AIO1EN_Pos                      (0)
#define ADC_ECFG_AIO1EN_Msk                      (0x1UL << ADC_ECFG_AIO1EN_Pos)
/** @} */
...
#define LPUSART_CORE                             ((LPUSARTCORE_TypeDef *) LPUSARTCORE_BASE_ADDR)
/**
  * @}
...
typedef struct {
    ...
    __IO uint32_t ATCR;                          /**< Actual Timer Counter Register,               offset: 0x24 */
} TIMER_TypeDef;
...
/** @name ATCR - TIMER_ATCR register */
/** @{ */
#define TIMER_ATCR_VALUE_Pos                      (0)
#define TIMER_ATCR_VALUE_Msk                      (0xFFFFFFFFUL << TIMER_ATCR_VALUE_Pos)
/** @} */
...
typedef enum _dma_request_source
{
    ...
    DMA_RequestLPUARTRX = 22,                    /**< LPUART RX                           */
