 ...
 * Project:      SPI (SSP used for SPI) Driver for Eigencomm EC616S
 * --------------------------------------------------------------------------
...
static PIN SPI1_pin_sclk  = {RTE_SPI1_SCLK_BIT,   RTE_SPI1_SCLK_FUNC};
static PIN SPI1_pin_ssn   = {RTE_SPI1_SSN_BIT,    RTE_SPI1_SSN_FUNC};
static PIN SPI1_pin_mosi  = {RTE_SPI1_MOSI_BIT,   RTE_SPI1_MOSI_FUNC};
static PIN SPI1_pin_miso  = {RTE_SPI1_MISO_BIT,   RTE_SPI1_MISO_FUNC};
