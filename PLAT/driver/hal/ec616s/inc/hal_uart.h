...
/**
  ...
  \param[in] uartIdx uart index
  \return    modem status, currently only cts state is supported
 */
...
/**
  ...
  \param[in]   uartIdx uart index
  \param[in]   control currently only ARM_USART_RTS_SET(active low) and ARM_USART_RTS_CLEAR is supported
 */
